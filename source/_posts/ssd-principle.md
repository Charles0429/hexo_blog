...
![Sequential Read](http://img.oserror.com/blog/ssd/ssd_sequential_read.png)

![Sequential Write](http://img.oserror.com/blog/ssd/ssd_sequential_write.png)

其中，Seagate ST3000DM001是HDD，其他的都是SSD。从上述两图中可以看出，HDD的顺序读速度差不多为最慢的SSD的一半，顺序写稍微好点，但也比大部分慢一倍左右的速度。

再来看随机读和随机写

![Random Read](http://img.oserror.com/blog/ssd/ssd_random_read.png)

![Random Write](http://img.oserror.com/blog/ssd/ssd_random_write.png)
...
![NAND Flash](http://img.oserror.com/blog/ssd/ssd_nand_flash.png)
...
![SSD New Write](http://img.oserror.com/blog/ssd/ssd_new_write.png)
...
![SSD Leave Idle](http://img.oserror.com/blog/ssd/ssd_write_leave_idle.png)
...
![SSD over-provisioning](http://img.oserror.com/blog/ssd/ssd_over_provisioning.png)
...
![garbage collection](http://img.oserror.com/blog/ssd/ssd_garbage_collection.png)
...
![no wear leveling](http://img.oserror.com/blog/ssd/no_wear_leveling.png)

大约为278天。而如果是完美的损耗均衡控制，即4096个block都均衡地参与更新，则使用寿命如下：

![perfect wear leveling](http://img.oserror.com/blog/ssd/perfect_wear_leveling.png)
